...
if (!read_cookie('civmod') && !localStorage.getItem('civmod')){
...
function load(loadType){
  ...
  if (loadType === 'cookie'){
    //check for cookies
    if (read_cookie('civmod') && read_cookie('civmod2')){
      //set variables to load from
      loadVar = read_cookie('civmod');
      loadVar2 = read_cookie('civmod2');
      //notify user
  ...
  if (loadType === 'localStorage'){
    ...
    var string2;
    try {
      string1 = localStorage.getItem('civmod');
      string2 = localStorage.getItem('civmod2');
    } catch(err) {
...
function updateResourceTotals(){
  ...
  if (Math.round(gold.total) > 0){
    document.getElementById('goldRow').style.display = 'block';
  ...
  if (smithy.total > 0) { document.getElementById('blacksmithgroup').style.display = 'block'; }
  if (tannery.total > 0) { document.getElementById('tannergroup').style.display = 'block'; }
  if (apothecary.total > 0) { document.getElementById('apothecarygroup').style.display = 'block'; }
  if (temple.total > 0) { document.getElementById('clericgroup').style.display = 'block'; }
  if (barracks.total > 0) { document.getElementById('soldiergroup').style.display = 'block'; }
  if (stable.total > 0) { document.getElementById('cavalrygroup').style.display = 'block'; }
...
function updatePopulation(){
  ...
  if (population.totalSick > 0){
    document.getElementById('sickGroup').style.display = 'block';
  }
  ...
  document.getElementById('popcurrent1').innerHTML = prettify(population.current);
  document.getElementById('popcap1').innerHTML = prettify(population.cap);
...
function updateJobButtons(job,name,building,support){
  ...
  if (building){
    elem.children[10].children[0].disabled = (population[job] <   1); // None
    elem.children[9].children[0].disabled = (population[job] < 100); // -100
    elem.children[8].children[0].disabled = (population[job] <  10); // - 10
    elem.children[7].children[0].disabled = (population[job] <   1); // -  1
    ...
    if ((job == 'soldiers' && metal.total >= 10 && leather.total >= 10 && population.unemployed >= 1 && population[job] + 1 <= building.total * support) || (job == 'cavalry' && food.total >= 20 && leather.total >= 20 && population.unemployed >= 1 && population[job] + 1 <= building.total * support) || (job != 'soldiers' && job != 'cavalry' && population.unemployed >= 1 && population[job] + 1 <= building.total * support)){ //1
      elem.children[1].children[0].disabled = false;
    } else if (job == 'soldiers' || job == 'cavalry') {
    ...
    if ((job == 'soldiers' && metal.total >= 100 && leather.total >= 100 && population.unemployed >= 10 && population[job] + 10 <= building.total * support) || (job == 'cavalry' && food.total >= 200 && leather.total >= 200 && population.unemployed >= 10 && population[job] + 10 <= building.total * support) || (job != 'soldiers' && job != 'cavalry' && population.unemployed >= 10 && population[job] + 10 <= building.total * support)){ //10
      elem.children[2].children[0].disabled = false;
    } else if (job == 'soldiers' || job == 'cavalry') {
      elem.children[2].children[0].disabled = true;
    }
    if ((job == 'soldiers' && metal.total >= 1000 && leather.total >= 1000 && population.unemployed >= 100 && population[job] + 100 <= building.total * support) || (job == 'cavalry' && food.total >= 2000 && leather.total >= 2000 && population.unemployed >= 100 && population[job] + 100 <= building.total * support) || (job != 'soldiers' && job != 'cavalry' && population.unemployed >= 100 && population[job] + 100 <= building.total * support)){ //100
      elem.children[3].children[0].disabled = false;
    } else if (job == 'soldiers' || job == 'cavalry') {
      elem.children[3].children[0].disabled = true;
    }
    if ((job == 'soldiers' && metal.total >= 10 && leather.total >= 10 && population.unemployed >= 1 && population[job] + 1 <= building.total * support) || (job == 'cavalry' && food.total >= 20 && leather.total >= 20 && population.unemployed >= 1 && population[job] + 1 <= building.total * support) || (job != 'soldiers' && job != 'cavalry' && population.unemployed >= 1 && population[job] + 1 <= building.total * support)){ //Max
      elem.children[4].children[0].disabled = false;
    } else if (job == 'soldiers' || job == 'cavalry') {
      elem.children[4].children[0].disabled = true;
    }
  } else {
    elem.children[10].children[0].disabled = (population[job]       <   1); // None
    elem.children[9 ].children[0].disabled = (population[job]       < 100); // -100
    elem.children[8 ].children[0].disabled = (population[job]       <  10); // - 10
    elem.children[7 ].children[0].disabled = (population[job]       <   1); // -  1
    elem.children[1 ].children[0].disabled = (population.unemployed <   1); //    1
    elem.children[2 ].children[0].disabled = (population.unemployed <  10); //   10
    elem.children[3 ].children[0].disabled = (population.unemployed < 100); //  100
    elem.children[4 ].children[0].disabled = (population.unemployed <   1); //  Max
  }
...
function updateUpgrades(){
  ...
  if (upgrades.masonry == 1){
    ...
    document.getElementById('cottageRow').style.display = 'block';
    document.getElementById('tanneryRow').style.display = 'block';
    document.getElementById('smithyRow').style.display = 'block';
    document.getElementById('apothecaryRow').style.display = 'block';
    document.getElementById('templeRow').style.display = 'block';
    document.getElementById('barracksRow').style.display = 'block';
  ...
  if (upgrades.architecture == 1){
    ...
    document.getElementById('mansionRow').style.display = 'block';
    document.getElementById('fortificationRow').style.display = 'block';
  ...
  //wheel
  if (upgrades.wheel == 1){
    document.getElementById('millRow').style.display = 'block';
  ...
  if (upgrades.horseback == 1){
    document.getElementById('stableRow').style.display = 'block';
  ...
  if (upgrades.lure == 1){
    ...
    document.getElementById('pLure').style.display = 'block';
  }
  //cats - companion
  if (upgrades.companion == 1){
    document.getElementById('companion').disabled = true;
    document.getElementById('pCompanion').style.display = 'block';
  }
  //cats - comfort
  if (upgrades.comfort == 1){
    document.getElementById('comfort').disabled = true;
    document.getElementById('pComfort').style.display = 'block';
  }
  //fields - blessing
  if (upgrades.blessing == 1){
    document.getElementById('blessing').disabled = true;
    document.getElementById('pBlessing').style.display = 'block';
  }
  //fields - waste
  if (upgrades.waste == 1){
    document.getElementById('waste').disabled = true;
    document.getElementById('pWaste').style.display = 'block';
  }
  //fields - stay
  if (upgrades.stay == 1){
    document.getElementById('stay').disabled = true;
    document.getElementById('pStay').style.display = 'block';
  }
  //battle - riddle
  if (upgrades.riddle == 1){
    document.getElementById('riddle').disabled = true;
    document.getElementById('pRiddle').style.display = 'block';
  }
  //battle - throne
  if (upgrades.throne == 1){
    document.getElementById('throne').disabled = true;
    document.getElementById('pThrone').style.display = 'block';
  }
  //battle - lament
  if (upgrades.lament == 1){
    document.getElementById('lament').disabled = true;
    document.getElementById('pLament').style.display = 'block';
  }
  //underworld - book
  if (upgrades.book == 1){
    document.getElementById('book').disabled = true;
    document.getElementById('pBook').style.display = 'block';
  }
  //underworld - feast
  if (upgrades.feast == 1){
    document.getElementById('feast').disabled = true;
    document.getElementById('pFeast').style.display = 'block';
  }
  //underworld - secrets
  if (upgrades.secrets == 1){
    document.getElementById('secrets').disabled = true;
    document.getElementById('pSecrets').style.display = 'block';
  }
  //trade - trade
  if (upgrades.trade == 1){
...
function updateMobs(){
  ...
  if (population.wolves > 0){
    document.getElementById('wolfgroup').style.display = 'block';
  ...
  if (population.bandits > 0){
    document.getElementById('banditgroup').style.display = 'block';
  ...
  if (population.barbarians > 0){
    document.getElementById('barbariangroup').style.display = 'block';
  ...
  if (population.esiege > 0){
    document.getElementById('esiegegroup').style.display = 'block';
  ...
  if (population.shades > 0){
    document.getElementById('shadesgroup').style.display = 'block';
...
function updateParty(){
  ...
  if (population.esoldiers > 0){
    document.getElementById('esoldiergroup').style.display = 'block';
  } else {
    document.getElementById('esoldiergroup').style.display = 'none';
  }
  if (population.eforts > 0){
    document.getElementById('efortgroup').style.display = 'block';
  } else {
...
function updateWonder(){
  ...
  if (wonder.building){
    ...
    document.getElementById('labourergroup').style.display = 'block';
...
function save(savetype){
  ...
  //Create the cookies
  bake_cookie('civmod',saveVar);
  bake_cookie('civmod2',saveVar2);
  //set localstorage
  try {
    localStorage.setItem('civmod', JSON.stringify(saveVar));
    localStorage.setItem('civmod2', JSON.stringify(saveVar2));
  } catch(err) {
  ...
  if ((read_cookie('civmod') && read_cookie('civmod2')) || (localStorage.getItem('civmod') && localStorage.getItem('civmod2'))){
...
function deleteSave(){
  ...
  if (really){
        document.cookie = ['civmod', '=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=/; domain=.', window.location.host.toString()].join('');
    document.cookie = ['civmod2', '=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=/; domain=.', window.location.host.toString()].join('');
    localStorage.removeItem('civmod');
    localStorage.removeItem('civmod2');
...
function toggleCustomIncrements(){
  ...
  if(customIncrements){
    ...
    document.getElementById('customJobIncrement').style.display = "block";
    document.getElementById('customArmyIncrement').style.display = "block";
...
function switchRunner(){
  var runner1 = window.runner1;
  var runner2 = window.runner2;

  if (runner1.style.display == "none") {
    runner2.style.display = "none";
    runner1.style.display = "";
  } else if (runner1.style.display == "") {
    runner1.style.display = "none";
    runner2.style.display = "";
  }
}
...
function showMenu(){
  ...
  if (menu.style.display == "none") {
    menu.style.display = "";
    if (window.currentPane) {
      document.getElementById(window.currentPane).style.display = "none";
    }
  } else if (menu.style.display == "") {
    menu.style.display = "none";
    if (window.currentPane) {
      document.getElementById(window.currentPane).style.display = "";
    }
  }
  switchRunner();
}

function showPane(p, n){
  if (window.currentPane) {
    document.getElementById(window.currentPane).style.display = "none";
  }
  document.getElementById(p).style.display = "";
  window.currentPane = p;
  window.menuLocation = n;
  window.nav.style.display = "none";
}

function getMenuLoc(l){
...
function swipePane(d){
  if (window.currentPane) {
    document.getElementById(window.currentPane).style.display = "none";
  }
//   document.getElementById(p).style.display = "";
//   window.currentPane = p;
  var newMenu = window.menuLocation + 1;
  if (d == "swiperight") {
    newMenu = window.menuLocation - 1
  }
  var menuArray = document.getElementsByTagName("li");
  var len = menuArray.length
  if (newMenu < 0) {
    newMenu = len - 1;
  } else if (newMenu > len - 1) {
    newMenu = 0;
  }
  window.menuLocation = newMenu;
  menuArray[newMenu].click();
}
